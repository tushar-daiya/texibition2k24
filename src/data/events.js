export const events = [
  {
    ...
    rules: [
      ...
      "Candidates are not allowed to consult with any external sources during the competition. Candidates involved in any malpractices will be disqualified automatically.",
  ...
  },
  {
    ...
    rules: [
      ...
      "Participants have to develop a full-fledged system which should be rectified by the respective department or departments.",
  ...
  },
  {
    ...
    rules: [
      ...
      "There may be negative marks for using abusive language and bad behaviour of the participant.",
