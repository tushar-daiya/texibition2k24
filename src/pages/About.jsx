...
const About = () => {
  return (
    <div className="mx-auto max-w-screen-lg px-5">
      <div className="about mt-8 flex flex-wrap font-clash text-[2.7rem]  font-bold leading-[3rem] tracking-wide text-white sm:text-[4.3rem]  md:text-[4.4rem] md:leading-[5rem] lg:text-[4.5rem] xl:text-[4.8rem] xl:tracking-[.5rem]">
      ...
      <p className="mt-8 font-chakra text-lg leading-loose md:text-xl">
      ...
      <p className="mt-5 font-chakra text-lg leading-loose md:text-xl">
