...
const About = () => {
  return (
    <div className="mx-auto max-w-screen-lg px-5">
      <div class="about mt-8 flex flex-wrap font-clash text-[2.7rem]  font-bold leading-[3rem] tracking-wide text-white sm:text-[4.3rem]  md:text-[4.4rem] md:leading-[5rem] lg:text-[4.5rem] xl:text-[4.8rem] xl:tracking-[.5rem]">
        <span>Okay cool! But</span>
        <span>hold on, what is</span>
        <span class="text-[4rem] sm:text-[4.5rem] md:mt-4 md:text-[5.2rem] lg:mt-5 lg:text-[6.2rem] xl:text-[7.5rem]">
          <span class="text-primary">
            <ScrambleTextHover text={"TEXIBITION"} />{" "}
          </span>
        </span>
        <span class="text-[3.7rem] sm:text-[5rem] md:mt-4 md:text-[7rem] lg:mt-8 lg:text-[9rem] xl:text-[12rem]">
          ?
        </span>
      </div>
